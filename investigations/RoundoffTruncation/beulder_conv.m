...
% 
% function [dxs,ers]=beulder_conv(funhand, funderhand, x, n, dx0,
% divFactor)
% 
...
% 
function [dxs,ers]=beulder_conv(funhand, funderhand, x, n, dx0, divFactor)
    dxs=[]; ers=[];
    dx=dx0;
    for i=1:n
        fdiff =funhand(x) - funhand(x-dx); 
        dfapp = (fdiff)/dx ;
        dfex  = funderhand(x);
