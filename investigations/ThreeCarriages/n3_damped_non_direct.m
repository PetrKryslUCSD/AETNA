% Direct numerical integration, Non-proportionally damped, 
function n3_damped_non_proportional_direct
    scale = 50;
    scalev = 5;
...
%     subplots
   ...
   fig2eps(['n3_oscillator_damped_non_Direct_mode' num2str(mode) '.eps'])
