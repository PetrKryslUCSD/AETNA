% Three carriages, non-proportionally damped, Singular stiffness, properties.
function [M,C,K,A,k1,k2,k3,c1,c2,c3] = properties_damped_sing_non_proportional
    m= 1.3;  k = 61;   c =33.3; % Mass, stiffness, damping parameters
    M = [m,0,0;
        0,m,0;
        0,0,m]; % Mass matrix
    k1=0; k2=k; k3=k;% Zero stiffness!
    K =[k1+k2,-k2,0;
        -k2,k2+k3,-k3;
