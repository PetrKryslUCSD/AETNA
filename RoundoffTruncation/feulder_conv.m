...
% 
% function [dxs,ers]=feulder_conv(funhand, funderhand, x, n, dx0,
% divFactor)
% 
...
% 
function [dxs,ers]=feulder_conv(funhand, funderhand, x, n, dx0, divFactor)
    dxs=[]; ers=[];
    dx=dx0;
    for i=1:n
        fdiff =funhand(x+dx) - funhand(x); 
        dfapp = (fdiff)/dx ;
        dfex  = funderhand(x);
